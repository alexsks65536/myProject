...
class Separator:
    ...
    def make_separator(self, sep_color, sep_back, sep_num, sep_sym, sep_effect, title):
        """
        ...
        sep1.make_separator('gray', 'black', 100, '-', 'bold', 'Новый раздел')
        ...
        :param title:      Наименование заголовка раздела
        :return:
        """
        ...
        print(f'\033{color}\033{back}{sep_num * sep_sym} {title} {sep_num * sep_sym}\033{effect}')
...
if __name__ == "__main__":
    ...
    for i in color_line:
        ...
        sep1.make_separator(color, back, 100, '@', effect, 'Новый раздел')
